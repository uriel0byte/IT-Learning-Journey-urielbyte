...
3. Since it's a png and the name of this ctf implies that it's about steganography, I used "zsteg <file>" to extract hidden text, files, or binary data within PNG image file.
4. It's there.
